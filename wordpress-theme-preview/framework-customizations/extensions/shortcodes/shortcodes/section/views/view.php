...
$section_id = ( isset( $atts['section_id'] ) && $atts['section_id'] ) ? 'id="' . $atts['section_id'] . '"' : '';
?>
<section <?php echo esc_attr($section_id) ?> class="<?php echo esc_attr($section_class) ?>" <?php echo $section_style; ?> <?php echo $bg_video_data_attr; ?>>
